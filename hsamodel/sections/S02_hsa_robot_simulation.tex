...
This subsection will introduce the governing equations of the \gls{DCM} following the work by Gazzola et al.~\citep{gazzola2018forward}.
...
We verify that our simulator can represent the steady-state behavior of a real \gls{HSA} by re-producing the characterization results for closed \glspl{HSA} by Good et al.~\citep{good2022expanding}.
...
% We refer the interested reader to the paper by Good et al.~\citep{good2022expanding} for more details on the exact identification procedure of each characteristics.
