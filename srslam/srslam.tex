...
\blfootnote{This chapter is partly based on \faFileTextO~\emph{Sensing Soft Robots' Shape with Cameras: an Investigation on Kinematics-Aware SLAM}~\cite{rosi2022sensing}.
}
