...
\begin{equation}\small\label{eq:srslam:Pi}
\begin{split}
...
\begin{equation}\small\label{eq:srslam:Psi}
\begin{split}
...
%
\begin{equation}\small\label{eq:srslam:cost_fun}
    \min_{\hat{q}} \sum_{i=1}^{n_\mathrm{S}} f_{\mathrm{t},i}(\hat{q}) + \lambda_\mathrm{R} f_{\mathrm{R},i}(\hat{q}),
\end{equation}
with
\begin{equation}\small\label{eq:srslam:cost_fun_ingredients}
\begin{split}
    f_{\mathrm{t},i}(\hat{q}) &=
    \big\lVert 
