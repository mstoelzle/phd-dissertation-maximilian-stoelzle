...
\noindent
\begin{longtable}{p{.20\textwidth} p{.75\textwidth}}
    Since 04/2025 & Postdoctoral Researcher at the Physical Intelligence (PhI) Lab, Department of Cognitive Robotics, Faculty of Mechanical Engineering, Delft University of Technology, The Netherlands.\\
...
\noindent
\begin{longtable}{p{.20\textwidth} p{.75\textwidth}}
    Michele Martini & Visiting PhD student from the Italian Institute of Technology (IIT) working on the co-design of soft robots.\\
    Lorenzo Paiola & Visiting PhD student from the University of Pisa.\\
    Iván López Broceño & MSc Robotics student at TU Delft. Master thesis on manipulation of ropes and other deformable objects.\\
    ...
    Emanuele Rosi & Visiting MSc student from the University of Genoa. Master thesis on \emph{Sensing soft robots' shape with cameras: an investigation on kinematics-aware SLAM}. Resulted in a RoboSoft conference paper~\citep{rosi2022sensing}.\\
\end{longtable}
...
\noindent
\begin{longtable}{p{.20\textwidth} p{.75\textwidth}}
    EMERGE & Led the effort and writing of deliverables D3.1\footnote{\url{https://edu.nl/qnny4}} and D3.2 and contributed to deliverables D3.3 and D4.1.\\
\end{longtable}