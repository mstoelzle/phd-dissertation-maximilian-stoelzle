...
\begin{abstract}
    ...
    Secondly, we derive a operational space impedance controller that allows us to unite the soft robot's embodied intelligence with computational intelligence to guarantee compliance and interaction safety.
