...
\input{hsacontrol/sections/S02_technical_approach}
\input{hsacontrol/sections/S03_experimental_validation}
\input{hsacontrol/sections/S04_experimental_insights}

\section*{Acknowledgments}
The authors thank Pietro Pustina for the valuable insights into a coordinate transformation into collocated variables, control of underactuated soft robots, and his help revising the manuscript.