...
\begin{foreword}
    In Chapter~\circled{\ref{chp:hsacontrol}}, we developed kinematic and dynamical models for planar \gls{HSA} robots. However, the control of \gls{HSA} remains an unexplored area, both in our previous chapters and in the existing literature. 
