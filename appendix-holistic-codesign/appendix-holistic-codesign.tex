...
\blfootnote{
    This chapter is partly based on \faFileTextO~\emph{\textbf{M. Stölzle}*, N. Pagliarani*, F. Stella, J. Hughes, C. Laschi, D. Rus, M. Cianchetti, C. Della Santina, and G. Zardini (2025). Soft yet Effective Robots via Holistic Co-Design. In Nature Machine Intelligence, \textbf{\emph{Under Review}}}.
