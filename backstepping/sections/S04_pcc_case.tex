...
% \begin{figure*}[ht]
%   \centering
%   \subfloat[Configuration $q$]{\includegraphics[width=0.33\textwidth]{figures/time_series_plot_configuration_v4.eps}\label{fig:time_series_plot_configuration}}
%   \subfloat[Piston position $\mu_\mathrm{p}$]{\includegraphics[width=0.33\textwidth]{figures/time_series_plot_piston_position_v4.eps}\label{fig:time_series_plot_piston_position}}
%   \subfloat[Actuation force $f_\mathrm{p}$]{\includegraphics[width=0.33\textwidth]{figures/time_series_plot_actuation_force_v4.eps}\label{fig:time_series_plot_actuation_force}}\\
...
\begin{figure*}[ht]
  ...
  % End-to-end PID
  \subfloat{\includegraphics[width=0.33\textwidth, trim={0.75cm 0.87cm 0.75cm 0cm}]{backstepping/figures/time_series_plot_configuration_full_system_PID_v2}}
  \subfloat{\includegraphics[width=0.33\textwidth, trim={0.75cm 0.87cm 0.75cm 0cm}]{backstepping/figures/time_series_plot_piston_position_full_system_PID_v2.eps}}
  \subfloat{\includegraphics[width=0.33\textwidth, trim={0.75cm 0.87cm 0.75cm 0cm}]{backstepping/figures/time_series_plot_actuation_force_full_system_PID_v2.eps}}\\
  % Coupling-aware PID
  \subfloat{\includegraphics[width=0.33\textwidth, trim={0.75cm 0.87cm 0.75cm 0cm}]{backstepping/figures/time_series_plot_configuration_coupling_aware_PID_v2.eps}}
  \subfloat{\includegraphics[width=0.33\textwidth, trim={0.75cm 0.87cm 0.75cm 0cm}]{backstepping/figures/time_series_plot_piston_position_coupling_aware_PID_v2.eps}}
  \subfloat{\includegraphics[width=0.33\textwidth, trim={0.75cm 0.87cm 0.75cm 0cm}]{backstepping/figures/time_series_plot_actuation_force_coupling_aware_PID_v2.eps}}\\
  % Backstepping
  \subfloat[Configuration $q$]{\includegraphics[width=0.33\textwidth, trim={0.75cm 0cm 0.75cm 0cm}]{backstepping/figures/time_series_plot_configuration_backstepping_v2.eps}}
  \subfloat[Piston position $\mu_\mathrm{p}$]{\includegraphics[width=0.33\textwidth, trim={0.75cm 0cm 0.75cm 0cm}]{backstepping/figures/time_series_plot_piston_position_backstepping_v2.eps}}
  \subfloat[Actuation force $f_\mathrm{p}$]{\includegraphics[width=0.33\textwidth, trim={0.75cm 0cm 0.75cm 0cm}]{backstepping/figures/time_series_plot_actuation_force_backstepping_v2.eps}}\\
...
% The partial derivative of the Lyapunov function of the soft system controller evaluates to $ \partial_{\dot{q}} H(q, \dot{q}) = \dot{q}^\mathrm{T} B(q)$, which allows us to re-formulate \eqref{eq:pi_psi}:
% \begin{equation}\small\label{eq:pi_pcc_set_point}
