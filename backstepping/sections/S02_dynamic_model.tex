...
All of kinematic modelling techniques produce multi\--body dynamics of the unactuated soft robot as follows~\cite{della2023model}
%
\begin{equation}
...
%
\begin{equation}\label{eq:backstepping:complete_dyn} %\small
\begin{split}
