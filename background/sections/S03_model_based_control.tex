...
% Here, the dynamics defined in Eq.~\ref{eq:background:dynamics:eom_operational_space} are leveraged to directly devise a controller in operational space~\citep{khatib1987unified}, where the dimensionality $o$ of the operational space reference (generally) needs to fulfill the condition $o \leq n$.
