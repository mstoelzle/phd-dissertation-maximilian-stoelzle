...
\title{Discovering and Leveraging Minimalist Models for Continuum Soft Robots}
...
\part{Discovering Minimalist Models}
\include{hsamodel/hsamodel}

\part{Leveraging Minimalist Models for Shape Sensing }
\include{srslam/srslam}
\include{promasens/promasens}

\part{Leveraging Minimalist Models for Control}
