...
\title{Discovering and Leveraging Compact Models for Continuum Soft Robots}
...
\part{Discovering Compact Models}
\include{hsamodel/hsamodel}
\include{con/con}

\part{Leveraging Compact Models for Shape Sensing }
\include{srslam/srslam}
\include{promasens/promasens}

\part{Leveraging Compact Models for Control}
